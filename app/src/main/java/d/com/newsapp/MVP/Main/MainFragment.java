...
public class MainFragment extends Fragment implements IMainPresenterContract.View, ContentAdapter.OnClickNews {
    ...
    private void intiViews( View view ) {
        ...
        if (getActivity() != null)
            ((HomeActivity) getActivity()).tittle.setText("الرئيسية");
    }

    private void createInstances() {
        contentList = new ArrayList<>();
        mainPresenterImp = new MainPresenterImp(this, getActivity());
        mainPresenterImp.getMainNews();
    }

    @Override
    public void showMainNewsList( List<ArticlesList> contentLists ) {
